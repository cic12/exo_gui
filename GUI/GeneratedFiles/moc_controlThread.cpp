...
QT_MOC_LITERAL(1, 14, 8), // "GUIComms"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "ControlThread\0GUIComms\0"
};
...
void ControlThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->GUIComms((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ControlThread::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ControlThread::GUIComms)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ControlThread::GUIComms(QString _t1)
{
